<%@ Page Title="Driver Registration" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DriverRegistration.aspx.cs" Inherits="BangersAndCo.RegisteredUser.DriverRegistration" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
	<h2><%: Title %>.</h2>
	<div class="alert alert-info alert-dismissible" role="alert">
		<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
		<strong>Info:</strong> You must register yourself as a driver before you can make your first booking.
	</div>
				...
				<section class="row">
					<section class="col-xs-12">
						<table class="table table-borderless table-condensed">
							...
							<tr><td>Date of Birth:</td><td><asp:TextBox ID="txtDateOfBirth" runat="server" Enabled="False" Text='<%#Eval("DateOfBirth") %>'></asp:TextBox></td></tr>
	...
	<section class="alert-timeout alert-hidden alert alert-success">
		...
		<strong>Success!</strong> Your registration details have been saved.
	</section>

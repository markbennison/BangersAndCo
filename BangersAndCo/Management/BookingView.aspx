<%@ Page Title="Booking View" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BookingView.aspx.cs" Inherits="BangersAndCo.Management.BookingView" %>
				...
				<section class="row">
					...
					<section class="col-xs-4 text-right">
						<h3>
							...
							<asp:linkbutton id="btnDeleteRecord" runat="server" CssClass="glyphicon glyphicon-trash btn disabled"/>
				...
				<section class="row">
					<section class="col-xs-12">
						<table class="table table-borderless table-condensed">
							...
							<tr><td>Driver:</td><td colspan="4"><asp:DropDownList ID="ddlDriver" runat="server" Enabled="False" ></asp:DropDownList></td></tr>						
							<tr><td>Requested From:</td><td><asp:TextBox ID="txtDateFrom" runat="server" Enabled="False" Text='<%#Eval("[DateTimeFrom]", "{0:yyyy-MM-dd}" ) %>' TextMode="Date"></asp:TextBox>
								...
								<td>Actual Pickup:</td><td><asp:TextBox ID="txtDatePickup" runat="server" Enabled="False" Text='<%#Eval("[DateTimePickup]", "{0:yyyy-MM-dd}" ) %>' TextMode="Date"></asp:TextBox>
								<asp:TextBox ID="txtTimePickup" runat="server" Enabled="False" Text='<%#Eval("[DateTimePickup]", "{0:HH:mm}") %>' TextMode="Time"></asp:TextBox></td></tr>
							...
							<tr><td>Expected Return:</td><td><asp:TextBox ID="txtDateDue" runat="server" Enabled="False" Text='<%#Eval("[DateTimeDue]", "{0:yyyy-MM-dd}" ) %>' TextMode="Date"></asp:TextBox>
								...
								<td>Actual Return:</td><td><asp:TextBox ID="txtDateReturn" runat="server" Enabled="False" Text='<%#Eval("[DateTimeReturn]", "{0:yyyy-MM-dd}" ) %>' TextMode="Date"></asp:TextBox>
								<asp:TextBox ID="txtTimeReturn" runat="server" Enabled="False" Text='<%#Eval("[DateTimeReturn]", "{0:HH:mm}") %>' TextMode="Time"></asp:TextBox></td></tr>
				...
				<section class="row">
					...
					<section class="col-xs-4 text-right">
						<h3>
							...
							<asp:linkbutton id="btnDeleteRecord" CommandName="DeleteRecord" runat="server" CssClass="glyphicon glyphicon-trash btn alert-danger"/>
							<asp:linkbutton id="btnListView" CommandName="ListView" runat="server" CssClass="glyphicon glyphicon-th-list btn"/>
						</h3>
					</section>
				</section>
					...
					<section class="col-xs-12">
						<table class="table table-borderless table-condensed">
							<tr><td>Booking ID:</td><td><asp:TextBox ID="txtBookingID" runat="server" Enabled="False" Text='<%#Bind("[ID]") %>'></asp:TextBox></td>
								<td>Status:</td><td><asp:DropDownList ID="ddlStatus" runat="server" Enabled="True" SelectedValue='<%# Bind("Status") %>'>
									<asp:ListItem Text="Booked" Value="Booked" />
									<asp:ListItem Text="Did Not Show" Value="Did Not Show" />
									<asp:ListItem Text="Active" Value="Active" />
									<asp:ListItem Text="Late" Value="Late" />
							...
							<tr><td>Driver:</td><td colspan="4"><asp:DropDownList ID="ddlDriver" runat="server" Enabled="True" AutoPostBack="True" OnSelectedIndexChanged="DdlDriver_SelectedIndexChanged"></asp:DropDownList></td></tr>
							...
							<tr><td>Requested From:</td><td><asp:TextBox ID="txtDateFrom" runat="server" Enabled="True" Text='<%#Bind("[DateTimeFrom]", "{0:yyyy-MM-dd}" ) %>' TextMode="Date" 
								...
								<td>Actual Pickup:</td><td><asp:TextBox ID="txtDatePickup" runat="server" Enabled="True" Text='<%#Bind("[DateTimePickup]", "{0:yyyy-MM-dd}") %>' TextMode="Date"
																		AutoPostBack="True" OnTextChanged="DateTimeTextBoxes_TextChanged"></asp:TextBox>
								<asp:TextBox ID="txtTimePickup" runat="server" Enabled="True" Text='<%#Bind("[DateTimePickup]", "{0:HH:mm}") %>' TextMode="Time"></asp:TextBox></td></tr>
							...
							<tr><td>Expected Return:</td><td><asp:TextBox ID="txtDateDue" runat="server" Enabled="True" Text='<%#Bind("[DateTimeDue]", "{0:yyyy-MM-dd}") %>' TextMode="Date"
								...
								<td>Actual Return:</td><td><asp:TextBox ID="txtDateReturn" runat="server" Enabled="True" Text='<%#Bind("[DateTimeReturn]", "{0:yyyy-MM-dd}") %>' TextMode="Date"
																		AutoPostBack="True" OnTextChanged="DateTimeTextBoxes_TextChanged"></asp:TextBox>
								<asp:TextBox ID="txtTimeReturn" runat="server" Enabled="True" Text='<%#Bind("[DateTimeReturn]", "{0:HH:mm}") %>' TextMode="Time"></asp:TextBox></td></tr>
							...
							<tr>
								<td>Hourly Rate: </td>
								<td><asp:TextBox ID="txtDailyRateCharged" runat="server" Enabled="True" Text='<%#Bind("[DailyRateCharged]", "£{0:#,##0.00}") %>' ></asp:TextBox></td>
								<td><asp:Label ID="lblTotalCharged" runat="server" Text=""></asp:Label></td>
								<td><asp:TextBox ID="txtTotalCharged" runat="server" Enabled="False"></asp:TextBox></td>
							</tr>
					...
					<section class="col-xs-12">
						<table class="table table-borderless table-condensed">
							...
							<tr><td>Requested From:</td><td><asp:TextBox ID="txtDateFrom" runat="server" Enabled="True" Text='<%#Bind("[DateTimeFrom]", "{0:yyyy-MM-dd}") %>' TextMode="Date" 
								...
								<td>Actual Pickup:</td><td><asp:TextBox ID="txtDatePickup" runat="server" Enabled="True" Text='<%#Bind("[DateTimePickup]", "{0:yyyy-MM-dd}") %>' TextMode="Date"
																		AutoPostBack="True" OnTextChanged="DateTimeTextBoxes_TextChanged"></asp:TextBox>
								<asp:TextBox ID="txtTimePickup" runat="server" Enabled="True" Text='<%#Bind("[DateTimePickup]", "{0:HH:mm}") %>' TextMode="Time"></asp:TextBox></td>
							...
							<tr>
								...
								<td>Please check the following customer documents:
